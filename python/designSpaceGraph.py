...
class designSpaceGraph():
    ...
    def __init__(self):
        ...
        self.taxa={}
        self.countOfTaxa=0
        self.graph=nx.Graph(name="Design Space", GraphID=1, is_directed=False)
        self.minMaxGraph=nx.Graph(name="Minmax Graph", GraphID=2, is_directed=False)
        ...
        self.classification=\
            {1:{1:"Proximal Quarter",2:"Second-most Proximal Quarter",3:"Third-most Proximal Quarter",4:"Distal Quarter"},
    ...
    def compareTaxa(self, taxa1, taxa2):
        ...
        for t in self.taxa[taxa1]:
            ...
            if t == self.taxa[taxa2][count]:
                ...
                #print t, "-", taxa2, "-", count
                #change = self.dimensions[count+1]+":"+\
                #         self.classification[count+1][int(self.taxa[taxa2][count])]+\
                #         "->"+self.classification[count+1][int(t)]
    ...
    def graphOutput(self):
        ...
        os.environ["PATH"] += ":/usr/local/graphviz-devel/lib/graphviz/:/usr/local/bin:/usr/local/opt/graphViz/:"
        ...
        font = {'fontname': 'Helvetica',
                ...
                'fontsize': 10}
        plt.axis('off')
        plt.savefig(gmlfilename, dpi=400)
        plt.show()
...
python ./designSpaceGraph.py --inputfile=../testdata/pfg.txt "


As a module:

from designSpaceGraph import designSpaceGraph
